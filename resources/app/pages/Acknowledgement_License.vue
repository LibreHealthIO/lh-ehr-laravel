<template>
    <div>
        <div class="p-10">
            <h1 class="text-2xl font-semibold mb-3 underline">Acknowledgments, Licensing and Certification</h1>
            <h3 class="text-xl font-semibold">License information</h3>
            ...
            <h3 class="text-xl font-semibold">Websites</h3>
            <div class="paragraph">
...
<script>
    ...
    export default {
        name: 'Acknowledgments_Licensing',

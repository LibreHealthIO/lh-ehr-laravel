<template>
    <div class="text-black">
        <div v-if="meta && meta.type === 'user'" class="flex justify-start">
            ...
            <div v-else>
                <inertia-link v-if="data.user.username" :href="route('user.profile', data.user.username)" class="flex items-center hover:text-theme-1">
                    <div class="mr-2">
        ...
        <div v-else-if="meta && meta.type === 'patient'" class="flex justify-start">
            <inertia-link :href="route('patients.show', data.id)" class="flex items-center hover:text-theme-1">
                <div class="mr-2">
                    <img class="w-6 h-6 rounded-full" :src="data.thumbnail" :alt="data.display_name" />
                </div>
                <div class="flex flex-col">

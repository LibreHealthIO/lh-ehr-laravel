<template>
    <div>
        <notificationGroup group="foo">
            <div class="fixed inset-0 z-200 flex px-4 py-6 pointer-events-none p-6 items-start justify-end text-left right-0">
                <div class="max-w-sm z-200 w-full">
                    <notification v-slot="{ notifications }">
                        <div v-for="notification in notifications" :key="notification.id">
                            <div v-if="notification.type === 'info'"
                                 class="flex max-w-sm w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden mt-4">
                                <div class="flex justify-center items-center w-12 bg-blue">
                                ...
                                <div class="-mx-3 py-2 px-4">
                                    <div class="mx-3">
                                        ...
                                        <p v-html="notification.text" class="text-gray-600 text-sm"></p>
                                    </div>
                                </div>
                            </div>
                            <div v-if="notification.type === 'warning'"
                                 class="flex max-w-sm w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden mt-4">
                                <div class="flex justify-center items-center w-12 bg-theme-12">
                            ...
                            <div v-if="notification.type === 'success'"
                                 class="flex max-w-sm w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden mt-4">
                                <div class="flex justify-center items-center w-12 bg-theme-1">
                                    <svg class="h-6 w-6 fill-current text-white" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="-mx-3 py-2 px-4">
                                    <div class="mx-3">
                                        <span class="text-green font-semibold">{{ notification.title }}</span>
                                        <p v-html="notification.text" class="text-gray-600 text-sm"></p>
                                    </div>
                                </div>
                            </div>
                            <div v-if="notification.type === 'error'"
                                 class="flex max-w-sm w-full mx-auto bg-white shadow-md rounded-lg overflow-hidden mt-4">
                                <div class="flex justify-center items-center w-12 bg-theme-6">
                                    <svg class="h-6 w-6 fill-current text-white" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">

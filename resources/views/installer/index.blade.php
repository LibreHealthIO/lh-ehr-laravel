...
@section('content')
    <div class="w-full h-screen flex">
        <img src="https://www.letscale.com/wp-content/uploads/2019/09/cybersecurity-threats-in-healthcare-small-business-IT-support-IT-solutions-cyber-secure-your-medical-practice-patient-data-e1567535830655.jpg"
                            ...
                            <div class="w-full px-3">
                                ...
                                <input class="appearance-none block w-full bg-white text-gray-700 border border-gray-500
                                 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                                       id="email" value="@if(old("email") != null) {{ old("email") }} @endif"
                                       name="email" type="text" minlength="3" maxlength="50" required placeholder="Email/Username">
                            </div>
                        </div>
                        <div class="-mx-3 mb-2">
                            <div class="w-full px-3">

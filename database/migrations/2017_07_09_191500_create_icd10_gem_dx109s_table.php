...
class CreateIcd10GemDx109sTable extends Migration
{
    /**
     * Run the migrations.
     * This creates icd10_gem_dx109s table.
     * From UI, Administration -> Other -> External Data Load -> ICD10.
     * @author Priyanshu Sinha <pksinha217@gmail.com>
     * @author Mua N. Laurent <pksinha217@gmail.com>
     * @return void
     */
    public function up()
    {
        Schema::create('icd10_gem_dx109s', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('revision', 0)->default(0)
    ...
    {
        Schema::dropIfExists('icd10_gem_dx109s');
    }
}

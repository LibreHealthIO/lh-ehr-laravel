...
(function ($) {
    ...
    let Combodate = function (element, options) {
    ...
    Combodate.prototype = {
        ...
        init: function () {
            ...
            this.$widget = $('<div class="combodate flex"></div>').html(this.getTemplate());
        ...
        */
        getTemplate: function () {
            ...
            $.each(this.map, function (k, v) {
                ...
                tpl = tpl.replace('{' + token + '}', '<div class="lg:w-4/12 md:w-4/12 sm:w-1/3" style="padding: 1px;"> <select class="' + k + ' ' + customClass + '"' +
